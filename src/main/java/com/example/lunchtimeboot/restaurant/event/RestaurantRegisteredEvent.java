...
public class RestaurantRegisteredEvent extends Event {

    private UUID restaurantId;
    private String restaurantName;
    private Location restaurantLocation;

    public RestaurantRegisteredEvent(UUID restaurantId, String restaurantName, Location restaurantLocation) {
